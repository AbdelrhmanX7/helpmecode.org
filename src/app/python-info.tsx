    ...
    <div className="mx-auto max-w-3xl p-6">
      ...
      <ul className="mb-4 list-decimal pl-5">
        ...
        <li>
          ...
          &quot;if&quot;, &quot;else&quot;, and &quot;elif&quot; statements, and
          building decision-making programs.
        </li>
        <li>
          <strong>Week 4:</strong> Loops (For and While) - Introduction to
          &quot;for&quot; and &quot;while&quot; loops to create repeating
          actions in programs.
        </li>
        <li>
        ...
        <li>
          ...
          common Python errors, using &quot;try&quot; and &quot;except&quot;,
      ...
      <p className="mb-4 text-lg">
        ...
        <strong>helpmecodeorgs@gmail.com</strong>.
      </p>
